...
spatialMatrix<-apply(covariateMatrix,1,median,na.rm=T)
temporalMatrix<-apply(covariateMatrix,2,median,na.rm=T)
...
qplot(bugs.data$spatialMatrix,apply(bugs.data$temporalMatrix,1,sd))
...
#including current and previous year rodent effects
