...
#specific initial values
inits<- function(){
  list(beta.auto=runif(1,0,1),int.d=runif(1,0,5))}
#predDensity=bugs.data$priorDensity,
out1 <- jags(bugs.data, inits=inits, params, "combined_model_weather_interaction_rodent_additive.txt", n.thin=nt,n.chains=3, n.burnin=30,n.iter=100,parallel = T)
