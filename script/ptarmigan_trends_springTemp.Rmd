...
bugs.data$spatialMatrix2 <- bugs.data$spatialMatrix-0.5
bugs.data$temporalMatrix2 <- bugs.data$temporalMatrix-0.5
...
params <- c("int.r","line.r.sd","year.r.sd","site2.r.sd","year.site2.r.sd","beta.t","beta.s","preds")
...
#no support for quadratic interaction effect

print(out1,2)
#positive effect temporally (more in warmer years)
#negative effect spatially (more in colder places)
...
inits<- function(){
  list(beta.auto=runif(1,0,1)),Density=bugs.data$priorDensity}
    
out1 <- jags(bugs.data, inits=inits, params, "combined_model_weather_interaction_rodent_additive.txt", n.thin=nt,n.chains=3, n.burnin=3000,n.iter=10000,parallel = T)
