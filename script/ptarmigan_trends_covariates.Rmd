...
allDetections$detectionLineYear<-
  as.numeric(factor(interaction(allDetections$LinjeID,(allDetections$Year-2006))))
allDetections$detectionSiteYear<-
  as.numeric(factor(interaction(allDetections$Rapporteringsniva,(allDetections$Year-2006))))
